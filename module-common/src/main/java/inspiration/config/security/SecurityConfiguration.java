...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public static final String[] ALLOWED_URI_PATTERN = {"/api/v1/signup", "/api/v1/auth", "/api/v1/reissue", "/api/v1/members/sends-email/reset-passwords", "/health", "/api/v1/auth/email/signup", "/api/v1/signup/extra-informations" };
